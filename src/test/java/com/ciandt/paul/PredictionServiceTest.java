...
@SpringBootTest(classes = {PredictionService.class, MatchDAO.class, Config.class,
        S3Utils.class, ContextBuilder.class, FifaRankDAO.class, TeamHistoryDAO.class, PredictorFactory.class,
        MatchDAO.class})
